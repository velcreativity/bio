...
- 경영검토: 검토기간 = 전년 검토기간 **연도만 +1 (월·일 동일)** → 2026.01–2026.03, 검토일 2026.03.11
- 품질목표 2026: 기존 목표 1·2 무수정 유지 + 신규 목표 3 **"제품허가팀 문서관리 체계 정착" (승인 완료)**
  — 문서 전체 정합 전파 (검토세션 §3.1)
...
- 품질실적모음_2026 잔여 작업 (품질심사만 진행):
  1. 경영검토서 재맥락화 — 검토기간(+1년 롤) 적용됨, 세부내용을 나머지 페이지와 1:1 정합 (검토세션 §2)
  2. 품질목표 — 목표 3 "제품허가팀 문서관리 체계 정착" 승인 완료, 문서 전체 전파 (검토세션 §3.1)
